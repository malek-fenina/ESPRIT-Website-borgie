...
<html lang="en">
  <head>
    ...
    <title>Admin Delete Reclamation</title>
  ...
  <body>
  <form name="f" action="main.php" method="post" onsubmit="return validervide2();">
  ...
  <section id="main">
    ...
    <?php affichage(); ?>
    <hr>
  <center><h3>Choisir la reference du reclamation a Supprimer !</h3></center>
  <center><input type="text" placeholder="reference" name="recDelete" onblur="queDesChiffres(this);"/></center>
  <center><span id="error2"></span></center>
  <br>
  <center><button type="submit" >Supprimer</button></center>
  <input type="hidden" name="action" value="recDelete">
    </div>
    </div>
