...
<html lang="en">
  ...
  <body>
  <form name="f" action="main.php" method="post" onsubmit="return validervide1();">
  ...
  <section id="main">
    ...
    <?php afficha(); ?>
    <hr>
  <center><h3>Choisir l'ID du livraison a Supprimer !</h3></center>
  <center><input type="text" placeholder="ID livraison" name="livDelete" onblur="queDesChiffres(this);"/></center>
  <center><span id="error1"></span></center>
  <br>
  <center><button class="shopBtn" type="submit" >Supprimer</button></center>
  <input type="hidden" name="action" value="livDelete">
    </div>
    </div>
